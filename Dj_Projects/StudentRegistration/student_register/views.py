...
class HomeView(TemplateView):
    template_name = "student_register/home.html"
...
def student_add(request):
    ...
    return render(request, "student_register/student_add.html", context)

class StudentCreateView(SuccessMessageMixin, CreateView):
    model = Student
    form_class = StudentForm
    template_name = "student_register/student_add.html"
